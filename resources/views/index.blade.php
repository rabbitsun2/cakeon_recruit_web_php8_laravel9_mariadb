                        ...
                        <div id="hero-slide" class="carousel carousel-fade slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{asset('images/bg_office_1.jpg') }}"
                                        class="carousel-image img-fluid" alt="...">

                                    <div class="carousel-caption d-flex flex-column justify-content-end">
                                        <h1>CAKEON</h1>

                                        <p>It performs tasks such as robots and image recognition.</p>
                                        <p>CAKEON pursues PDCA's management philosophy <br>based on basic principles.</p>
                                    </div>
                                </div>

                                <div class="carousel-item">
                                    <img src="{{asset('images/bg_action_2.jpg') }}"
                                        class="carousel-image img-fluid" alt="...">

                                    <div class="carousel-caption d-flex flex-column justify-content-end">
                                        <h1>Be the hero yourself</h1>

                                        <p>Creativity and quickness start with a stable challenge.</p>
                                        <p>We realize one person, one project responsible management.</p>
                                        <p>It can be self-determined and developed by Agile methods.</p>
                                    </div>
                                </div>

                                <div class="carousel-item">
                                    <img src="{{asset('images/bg_general_3.jpg') }}"
                                        class="carousel-image img-fluid" alt="...">

                                    <div class="carousel-caption d-flex flex-column justify-content-end">
                                        <h1>Donation</h1>

                                        <p>A portion of the proceeds are used to hire people with disabilities.</p>
                                        <p>In addition, the cost is used for server hosting maintenance costs.</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-12 text-center mx-auto">
                        <h2 class="mb-5">Welcome to Cakeon Project</h2>
                    </div>

                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="donate.html" class="d-block">
                                <img src="{{asset('template/KindHeart-1.0.0/images/icons/hands.png') }}" class="featured-block-image img-fluid" alt="">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="donate.html" class="d-block">
                                <img src="{{asset('template/KindHeart-1.0.0/images/icons/heart.png') }}" class="featured-block-image img-fluid" alt="">

                                <p class="featured-block-text"><strong>Software</strong> Maker</p>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="donate.html" class="d-block">
                                <img src="{{asset('template/KindHeart-1.0.0/images/icons/receive.png') }}" class="featured-block-image img-fluid" alt="">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="donate.html" class="d-block">
                                <img src="{{asset('template/KindHeart-1.0.0/images/icons/free_dev_wanicon.png') }}" class="featured-block-image img-fluid" alt="">

                                <p class="featured-block-text"><strong>IDEA</strong> Program</p>
                            </a>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                        <img src="{{asset('template/KindHeart-1.0.0/images/group-people-volunteering-foodbank-poor-people.jpg') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="custom-block-wrap">
                            <img src="{{asset('template/KindHeart-1.0.0/images/causes/group-african-kids-paying-attention-class.jpg') }}"
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="custom-block-wrap">
                            <img src="{{asset('template/KindHeart-1.0.0/images/causes/poor-child-landfill-looks-forward-with-hope.jpg') }}"
                                class="custom-block-image img-fluid" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="custom-block-wrap">
                            <img src="{{asset('template/KindHeart-1.0.0/images/causes/african-woman-pouring-water-recipient-outdoors.jpg') }}"
                                class="custom-block-image img-fluid" alt="">
        ...
        <section class="volunteer-section section-padding" id="section_4">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <img src="{{asset('template/KindHeart-1.0.0/images/smiling-casual-woman-dressed-volunteer-t-shirt-with-badge.jpg') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-12">
                        <div class="news-block">
                            <div class="news-block-top">
                                <a href="news-detail.html">
                                    <img src="{{asset('template/KindHeart-1.0.0/images/news/medium-shot-volunteers-with-clothing-donations.jpg') }}"
                        ...
                        <div class="news-block mt-3">
                            <div class="news-block-top">
                                <a href="news-detail.html">
                                    <img src="{{asset('template/KindHeart-1.0.0/images/news/medium-shot-people-collecting-foodstuff.jpg') }}"
                                        class="news-image img-fluid" alt="">
                                </a>
                    ...
                    <div class="col-lg-4 col-12 mx-auto">
                        ...
                        <div class="news-block news-block-two-col d-flex mt-4">
                            <div class="news-block-two-col-image-wrap">
                                <a href="news-detail.html">
                                    <img src="{{asset('template/KindHeart-1.0.0/images/news/africa-humanitarian-aid-doctor.jpg') }}"
                                        class="news-image img-fluid" alt="">
                                </a>
                            </div>
                        ...
                        <div class="news-block news-block-two-col d-flex mt-4">
                            <div class="news-block-two-col-image-wrap">
                                <a href="news-detail.html">
                                    <img src="{{asset('template/KindHeart-1.0.0/images/news/close-up-happy-people-working-together.jpg') }}"
                                        class="news-image img-fluid" alt="">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-4 col-12 ms-auto mb-5 mb-lg-0">
                        <div class="contact-info-wrap">
                            ...
                            <div class="contact-image-wrap d-flex flex-wrap">
                                <img src="{{asset('template/KindHeart-1.0.0/images/avatar/pretty-blonde-woman-wearing-white-t-shirt.jpg') }}"
